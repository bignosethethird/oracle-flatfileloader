------------------------------------------------------------------------------
-- $Header: vcr/views/vw_validation_position_hpad.sql 1.2 2005/08/22 17:46:45BST ghoekstra DEV  $
------------------------------------------------------------------------------
-- Creation script for view VCR.VW_VALIDATION_POSITION_HPAD
--
...
-- sqlplus VCR/[password]@[instance] @vw_validation_position_hpad.sql
------------------------------------------------------------------------------
set feedback off;
prompt Creating view VCR.VW_VALIDATION_POSITION_HPAD

------------------------------------------------------------------------------
-- Create view
------------------------------------------------------------------------------

create or replace view VCR.VW_VALIDATION_POSITION_HPAD (
  SOURCE_ID
, AS_OF_DATE
, BASIS
, KEY
...
SELECT  sp.source_id,
       ...
       WHERE EXISTS (SELECT NULL 
                     ...
                     WHERE  slr.source_id   = sp.source_id 
